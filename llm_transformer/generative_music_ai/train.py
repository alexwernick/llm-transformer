...
MelodyPreprocessor class from 'melody_preprocessor.py'.
...
- _train_step: Executes a single training step, including forward pass
and backpropagation.
...
def _train_step(input, target, transformer):
    ...
    # See video for better explanation 58:00
